...
@trigger_error('The "prestashop.adapter.sql_manager.request_sql_form_data_validator service is deprecated. Use "prestashop.adapter.sql_manager.sql_query_validator" instead', E_USER_DEPRECATED);
